      ...
      <Dialog open={showStatusModal} onOpenChange={setShowStatusModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose a new status for this document and optionally add a comment.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={showCommentModal} onOpenChange={setShowCommentModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Add a comment to this document to provide feedback or additional information.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
      ...
      <Dialog open={showShareModal} onOpenChange={setShowShareModal}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Share this document with others by entering their email addresses and selecting a permission level.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div>
